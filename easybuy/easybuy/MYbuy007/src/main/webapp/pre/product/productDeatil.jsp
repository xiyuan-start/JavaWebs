...
<div class="i_bg">
    ...
    <div class="content">
        <div id="tsShopContainer">
            <div id="tsImgS">
                <a href="http://47.94.101.75/images/${product.fileName}" title="Images" class="MagicZoom" id="MagicZoom">
                    <img src="http://47.94.101.75/images/${product.fileName}" width="390" height="390"/>
                </a>
            </div>
        </div>
        <div class="pro_des">
           ...
           <div class="des_price">
            ...
            <div class="des_join">
                ...
                <span class="fl">
                     <img src="${ctx}/statics/images/j_car.png" onclick="addCart(),AddCart(${product.id});"/>
                </span>
            </div>
        </div>
    </div>
        ...
        <div class="l_list">
            ...
            <div class="des_border" id="p_details">
                ...
                <div class="des_con">
                    ...
                    <p align="center">
                        <img src="http://47.94.101.75/images/${product.fileName}" width="185" height="155">
                    </p>
                </div>
            </div>
        </div>
